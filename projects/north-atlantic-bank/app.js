(() => {
  ...
  window.addEventListener("load",queueScale,{once:true});
  if("ResizeObserver" in window)new ResizeObserver(queueScale).observe(document.querySelector(".device-stage"));
  document.fonts?.ready.then(queueScale);
